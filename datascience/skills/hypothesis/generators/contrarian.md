...
- **Complement** - this generator attacks recorded findings; hostile review of the artifact itself (code, notebook, writeup) is `devils-advocate:adversarial-review` with the data-scientist adversary
