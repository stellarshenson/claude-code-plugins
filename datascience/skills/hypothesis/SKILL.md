...
> **docdistance wins** - `examples/wmd-docdistance-*.md` are the latest canonical shape. On any conflict with this skill's guidance (section order, layout, phrasing), follow the docdistance example.
