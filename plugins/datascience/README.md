...
Four worked examples ship under [`skills/hypothesis/examples/`](skills/hypothesis/examples/) - `quantized-inference-experiments.md` is the primary reference, the `wmd-docdistance-*` pair shows the SOTA-document shape, and the `lexical-grounding-*` pair a long 12-round arc. Use `/datascience:hypothesis` to record a round, fan out the next, or conclude the design.
...
- [`skills/hypothesis/SKILL.md`](skills/hypothesis/SKILL.md) - hypothesis-driven experiments log + SOTA doc structure, the per-hypothesis template, and canonical-doc-across-runs management; four worked examples under [`skills/hypothesis/examples/`](skills/hypothesis/examples/) (`quantized-inference-experiments.md` is the primary reference); fanout mechanics in [`skills/hypothesis/references/fanout.md`](skills/hypothesis/references/fanout.md) with persona generators under [`skills/hypothesis/generators/`](skills/hypothesis/generators/)
