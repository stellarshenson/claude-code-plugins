...
- Questionnaire = static, defined in this skill (below).
...
## Standing directive overrides (optional; defaults in this skill)
...
## Resolved pattern (rewritten by this skill each run)
...
Read `svg-infographics-beautify.md` FULLY. Standing-directive overrides, the creative brief, the resolved-pattern slot this run will populate, and the history live there; the questionnaire and the dimension reference are in this skill.
