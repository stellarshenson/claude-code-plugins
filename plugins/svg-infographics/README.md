...
Reference: `skills/svg-infographics/rules/shapes.md`.
...
Reference: Arrow Construction section of `skills/svg-infographics/references/standards.md`.
...
Reference: Callout construction workflow in `skills/svg-infographics/references/standards.md`.
...
Skill: `svg-infographics:svg-infographics` (see `references/validation.md`).
...
|---------|--------------|
| `/svg-infographics:create` | Create SVG infographic(s) following the full grid-first workflow. Dispatches the `svg-infographics` umbrella skill - in-session fork, or one background agent per graphic - so user keeps working |
...
- [`skills/svg-infographics/SKILL.md`](skills/svg-infographics/SKILL.md) - main design skill (fork context). Links to reference files below
- [`skills/svg-infographics/references/tools.md`](skills/svg-infographics/references/tools.md) - full tool palette tree with quick lookup
- [`skills/svg-infographics/references/standards.md`](skills/svg-infographics/references/standards.md) - grid-first rules, CSS theme classes, arrow construction, callout construction workflow, audit gates
- [`skills/svg-infographics/references/workflow.md`](skills/svg-infographics/references/workflow.md) - sequential 6-phase workflow with gate checks + per-image checklist
- [`skills/svg-infographics/references/validation.md`](skills/svg-infographics/references/validation.md) - validator usage, severity ladder, classification rules, browser visual testing
