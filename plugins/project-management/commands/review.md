...
Read the `project-management` skill first for the document's own rules, then `devils-advocate/skills/adversarial-review/SKILL.md` - the single source of truth for the two modes, the rounds protocol, the spawn mechanics and the adversary personas in `adversaries/<name>.md`. Do NOT duplicate either here. This command is only the project-management entry point into that skill.
...
1. Read the `project-management` skill, then `devils-advocate/skills/adversarial-review/SKILL.md`
