...
- One entry per invocation. If multiple entries are over-max, run it per-entry; bulk extraction is intentionally not supported because each article needs its own title + scope decision.
