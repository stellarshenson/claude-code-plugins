...
- Marketing copy (landing page, email, ad, listing, README hero, launch post) → `digital-marketer`: message, claims, conversion, and AI-sounding phrasing rated by where the reader meets it. AI tells in docs or code comments → `slop-hunter` axis 9, as deletable weight; a fabricated statistic or citation anywhere → `slop-hunter` axis 10. Readability of explainer prose for a generalist → `popular-science`; how the page behaves and what the user perceives → `ux-designer`
