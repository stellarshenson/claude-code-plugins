...
12. **Measure every round and report it** - `review-tools cost` over that round's own transcripts, per the skill's *After the review* bullet; report elapsed wall clock, agent minutes and tokens with the round's findings
