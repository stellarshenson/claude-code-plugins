...
Do NOT run `/increment-plugin-version` - it bumps the plugins independently and would desync them from the library. Verify: the first count returns 22, the second returns 0.
