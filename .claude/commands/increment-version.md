...
4. `.claude-plugin/marketplace.json` - `"version"` field in ALL plugin entries AND the marketplace `metadata.version`
...
4. Update ALL version strings (3 plugin.json + 3 marketplace entries + 1 metadata) to the new version
