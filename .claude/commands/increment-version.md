...
3. `.claude-plugin/marketplace.json` - `"version"` field in **both** plugin entries AND the marketplace `metadata.version`
...
4. Update ALL 4 version strings (2 plugin.json + 2 marketplace entries) to the new version
