...
try:
    ...
    # simply absent on 3.13 - where the bare "No module named 'groundrails'" gives
    # no hint why. Narrow to groundrails itself so a broken transitive dep keeps
    # its own name.
    ...
    raise ModuleNotFoundError(
        ...
        "3.13+; on 3.12 reinstall the toolkit. Every subcommand needs it; the "
        "other toolkit CLIs are unaffected."
    ) from exc
